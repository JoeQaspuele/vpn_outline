class Buttons:
    ...
    INCREASE_LIMIT = "📊 Увеличить лимит" 
    REVOKE_KEY = "❌ Удалить ключ"
    BACK_TO_MAIN = "⬅️ Назад"

class AdminMessages:
    VIP_GRANTED = "✅ Пользователь {user_id} теперь VIP"
    LIMIT_UPDATED = "✅ Лимит пользователя {user_id} увеличен на {gb} ГБ"
    KEY_REVOKED = "🔑 Ключ пользователя {user_id} удалён"
    INPUT_USER_ID = "Введите ID пользователя:"
    INPUT_GB = "Введите количество ГБ:"

class Messages:
    WELCOME = "Привет! Этот бот позволяет получить VPN без ограничения по ск>
    HELP_PROMPT = "✍️ Опишите свою проблему.\nСреднее время ответа — 10-60 ми>
